...
if($_SESSION)
  { $user_id=$_SESSION['user_id']; 
    ...
    $result = mysqli_query($link, $sql);
        ...
        echo '<marquee behavior="slide" width="60%" hspace="35%" scrollamount="20px"><h1>Welcome to Admin Panel!</h1></marquee>';
        echo      "
        <div class='row'>
   ...
   echo "<center>
    ...
    <button class='btn btn-info btn-lg' type='submit'>View Members</button>
    </form>
    </center>";
   echo '</br>';
   echo "<center>
